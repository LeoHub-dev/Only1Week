                  ...
                  <div class="tab-content">
                      ...
                      <div role="tabpanel" class="tab-pane text-center row <?= ($last_active == $var) ? 'active' : ''; ?>" id="step<?= $contador_cuentas.$count ?>">
                          ...
                          <div class="col-md-12 center-block table-user">
                            ...
                            <p><a href="javascript:void(0);" class="btn btn-primary btn-xs table_pay_user" data-fid="<?= $cycle[$var]['table_father']->id_user; ?>" data-uid="<?= $cycle[$var]['table_child_1']->id_user; ?>" data-tid="<?= $cycle[$var]['table_id']; ?>" data-ttype="1" data-nchild="1">PAGAR</a></p>
                            ...
                            <p><a href="javascript:void(0);" class="btn btn-primary btn-xs table_pay_user" data-fid="<?= $cycle[$var]['table_father']->id_user; ?>" data-uid="<?= $cycle[$var]['table_child_2']->id_user; ?>" data-tid="<?= $cycle[$var]['table_id']; ?>" data-ttype="1" data-nchild="2">PAGAR</a></p>
                            ...
                            <p><a href="javascript:void(0);" class="btn btn-primary btn-xs table_pay_user" data-fid="<?= $cycle[$var]['table_father']->id_user; ?>" data-uid="<?= $cycle[$var]['table_child_3']->id_user; ?>" data-tid="<?= $cycle[$var]['table_id']; ?>" data-ttype="1" data-nchild="3">PAGAR</a></p>
                            <?php endif; ?>

                            <?php else : ?>

                            <?php if($cycle[$var]['table_father']->id_user != $user_info['id_user'] && $cycle[$var]['table_child_1'] && $cycle[$var]['table_child_1_status'] == 0 && $cycle[$var]['table_child_1']->id_user == $user_info['id_user']) : ?>
                            <p><a href="javascript:void(0);" class="btn btn-primary btn-xs table_pay_user" data-fid="<?= $cycle[$var]['table_father']->id_user; ?>" data-uid="<?= $cycle[$var]['table_child_1']->id_user; ?>" data-tid="<?= $cycle[$var]['table_id']; ?>" data-ttype="2" data-nchild="1">PAGAR</a></p>
                            

                            <?php elseif($cycle[$var]['table_father']->id_user != $user_info['id_user'] && $cycle[$var]['table_child_2'] && $cycle[$var]['table_child_2_status'] == 0 && $cycle[$var]['table_child_2']->id_user == $user_info['id_user']) : ?>
                            <p><a href="javascript:void(0);" class="btn btn-primary btn-xs table_pay_user" data-fid="<?= $cycle[$var]['table_father']->id_user; ?>" data-uid="<?= $cycle[$var]['table_child_2']->id_user; ?>" data-tid="<?= $cycle[$var]['table_id']; ?>" data-ttype="2" data-nchild="2">PAGAR</a></p>
                            <?php endif; ?>
